...
namespace MetadataExtractor.Formats.Exif.Makernotes
{
    ...
    public class DjiMakernoteDirectory : Directory
    {
        ...
        public float? GetAircraftSpeedY() => this.TryGetSingle(TagSpeedY, out var value) ? value : (float?)null;
        ...
        public float? GetAircraftSpeedZ() => this.TryGetSingle(TagSpeedZ, out var value) ? value : (float?)null;
        ...
        public float? GetAircraftPitch() => this.TryGetSingle(TagAircraftPitch, out var value) ? value : (float?)null;
        ...
        public float? GetAircraftYaw() => this.TryGetSingle(TagAircraftYaw, out var value) ? value : (float?)null;
        ...
        public float? GetAircraftRoll() => this.TryGetSingle(TagAircraftRoll, out var value) ? value : (float?)null;
        ...
        public float? GetCameraPitch() => this.TryGetSingle(TagCameraPitch, out var value) ? value : (float?)null;
        ...
        public float? GetCameraYaw() => this.TryGetSingle(TagCameraYaw, out var value) ? value : (float?)null;
        ...
        public float? GetCameraRoll() => this.TryGetSingle(TagCameraRoll, out var value) ? value : (float?)null;
    }
}
